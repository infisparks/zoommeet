...
export const api = {
   ...
   */
  async updateMeetingLocks(meetingId: string, updates: { isVoiceLocked?: boolean; isVideoLocked?: boolean; onlyShowHost?: boolean; showCommentPopup?: boolean; isChatLocked?: boolean; fakeUserCount?: number }) {
    try {
